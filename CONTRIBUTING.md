...
The Zila GitHub repository has a lot of issues and PRs to keep track of. This
...
1. **Ensure that the release crate has no path dependencies.** When the HEAD
   version of a Zila crate requires unreleased changes in another Zila crate,
...
4. **Update the changelog for the crate.** Each crate in the Zila repository
